  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto px-6 lg:px-8 text-center">
        <p className="section-tag mb-6">Konsultasi Project &amp; Penawaran Vendor</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            className="btn-primary inline-flex items-center justify-center gap-2.5 px-7 py-4 rounded-xl text-base font-semibold shadow-lg shadow-emerald-500/20"
          >
