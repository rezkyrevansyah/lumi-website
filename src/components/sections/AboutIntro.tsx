      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          >
            ...
            <div className="absolute w-72 sm:w-88 h-72 sm:h-88 rounded-full bg-gradient-to-tr from-[#2DD9A4]/20 via-emerald-400/10 to-transparent filter blur-3xl pointer-events-none -z-10" />

            {/* Standalone Large Vector Logo */}
            <div className="relative w-full max-w-[290px] sm:max-w-[350px] flex flex-col items-center">
          ...
          >
            ...
            <div className="pt-2">
              <a
                ...
                className="btn-primary inline-flex items-center gap-2 px-5 py-3 rounded-xl text-sm font-semibold shadow-md shadow-emerald-500/15 transition-transform duration-150 active:scale-[0.96]"
              >
